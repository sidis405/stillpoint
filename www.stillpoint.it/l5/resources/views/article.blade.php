      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            ...
            <h2>{{$item->title}}</h2>
            <span class="shares">
            	<a href="https://www.facebook.com/sharer/sharer.php?u=http://stillpoint.it/articolo/{{$item->slug}}" target="_blank">
            						<i class="fa fa-facebook-official"></i>
            	      </a>
            	      <a href="https://twitter.com/share?url=http://stillpoint.it/articolo/{{$item->slug}}&text={{$item->title}}">
